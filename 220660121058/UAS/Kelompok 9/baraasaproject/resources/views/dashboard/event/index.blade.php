    ...
    <x-slot name="post">
        ...
        <div class="card">
            <div class="card-header">
                <div class="card-title fs-3 fw-bolder">Daftar Acara</div>
                <div class="card-toolbar">
                    @if (Auth::user()->hasAnyRole('super_administrator|administrator'))
                    <a class="btn btn-sm btn-light-primary" data-bs-toggle="tooltip" title="Tambah Acara"
        ...
        <script>
            $(document).on('click', '.delete', function () {
                ...
                swal.fire({
                    ...
                    if (result.value) {
                        var url = '{{ route("event.destroy", ":event") }}';
