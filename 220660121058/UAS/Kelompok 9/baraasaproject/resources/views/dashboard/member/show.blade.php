    ...
    <x-slot name="toolbar">
        <x-dashboard.toolbar.main>
            ...
            <x-slot name="breadcrumb">
                ...
                <li class="breadcrumb-item text-muted">Rincian Anggota</li>
            </x-slot>
        </x-dashboard.toolbar.main>
    </x-slot>
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex flex-stack fs-4 py-3">
                            <div class="fw-bolder rotate collapsible" data-bs-toggle="collapse"
                                ...
                                aria-controls="kt_user_view_details">Rincian Anggota
                        ...
                        <div id="kt_user_view_details" class="collapse show">
                            <div class="pb-5 fs-6">
                                ...
                                <div class="text-gray-600">{{ $member->phone_number }}</div>
                                ...
                                <div class="text-gray-600">
                                    {{ $member->birthplace . ', ' . $date_of_birth->format('j F Y'); }}
                                </div>
