<x-dashboard.layout>
    ...
    <x-slot name="toolbar">
        <x-dashboard.toolbar.main>
            ...
            <x-slot name="breadcrumb">
                ...
                <li class="breadcrumb-item text-muted">Ubah Jurnal</li>
            </x-slot>
        </x-dashboard.toolbar.main>
    </x-slot>
    ...
    <x-slot name="post">
        ...
        {{-- Start::Content --}}
        <form class="form" action="{{ route('research.update', $research->id) }}" method="POST" autocomplete="off"
            enctype="multipart/form-data">
            @csrf
            @method('PATCH')
            <div class="card">
                <div class="card-header">
                    <div class="card-title fs-3 fw-bolder">Ubah Jurnal</div>
                ...
                <div class="card-body">
                    <div class="mb-6">
                        ...
                        <input class="form-control" type="text" name="title" value="{{ $research->title }}" required>
                    </div>
                    <div class="mb-6">
                        <label class="form-label">Tanggal Terbit</label>
                        <input class="form-control flatpickr" type="text" name="date_of_publish"
                            value="{{ $research->date_of_publish }}" required>
                    </div>
                    <div>
                        <label class="form-label">
                            <span>Berkas Jurnal</span>
