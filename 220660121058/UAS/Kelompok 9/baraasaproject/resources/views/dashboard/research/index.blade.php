    ...
    <x-slot name="post">
        ...
        <div class="card">
            <div class="card-header">
                <div class="card-title fs-3 fw-bolder">Daftar Jurnal</div>
                <div class="card-toolbar">
                    <a class="btn btn-sm btn-light-primary" data-bs-toggle="tooltip" title="Tambah Jurnal"
        ...
        <script>
            $(document).on('click', '.delete', function () {
                ...
                swal.fire({
                    ...
                    if (result.value) {
                        var url = '{{ route("research.destroy", ":research") }}';
                        url = url.replace(':research', id);
