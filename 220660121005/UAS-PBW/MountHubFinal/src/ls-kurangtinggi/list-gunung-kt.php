        ...
        <div class="infoin p-5">
          <div class="row">
            <h1 class="col-12 fs-6">
              2 puncak dengan ketinggian antara 1.000 dan 2.000 meter (dan keunggulan lebih dari 1.000 meter) di provinsi Jawa Barat<br />
          ...
          <div class="row">
            <h2 class="fw-bold fs-4">
              Statistik dan Tautan ke Ribus Kurang Tinggi
            </h2>
            <h1 class="col-12">
              <table>
                <thead>
                ...
                <tbody>
                  <tr>
                    <td><a href="info-sawal.php">Sawal</a></td>
                    <td>1.764 meter persegi</td>
                    <td>1.041 meter persegi</td>
                    <td>Jawa Barat</td>
                    <td>Java</td>
                  </tr>
                  <tr>
                    <td><a href="info.tampomas.php">Tampomas</a></td>
                    <td>1.684 meter persegi</td>
                    <td>1.106 meter persegi</td>
                    <td>Jawa Barat</td>
                    <td>Java</td>
                  </tr>
                </tbody>
