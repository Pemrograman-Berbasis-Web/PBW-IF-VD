        ...
        <div class="infoin p-5">
          <div class="row">
            <h1 class="col-12 fs-6">
              2 puncak dengan ketinggian lebih dari 3.000 meter (dan ketinggian
              lebih dari 1.000 meter) <br />
          ...
          <div class="row">
            <h2 class="fw-bold fs-4">
              Statistik dan Tautan ke Ribus Sangat Tinggi
            </h2>
            <h1 class="col-12">
              <table>
                <thead>
                ...
                <tbody>
                  <tr>
                    <td><a href="info-ciremai.php">Ciremai</a></td>
                    <td>3.078 meter persegi</td>
                    <td>2.792 meter persegi</td>
                    <td>Jawa Barat</td>
                    <td>Java</td>
                  </tr>
                  <tr>
                    <td><a href="info-pangrango.php">Pangrango</a></td>
                    <td>3.020 meter persegi</td>
                    <td>2.427 meter persegi</td>
                    <td>Jawa Barat</td>
                    <td>Java</td>
                  </tr>
                </tbody>
