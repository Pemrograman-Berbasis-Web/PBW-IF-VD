...
// Ambil data produk dari database hanya kategori Jaket Gunung
$query = "SELECT * FROM products WHERE category = 'Jaket Gunung'";
...
<body>
    ...
    <div class="container">
        ...
        <a class="navbar-brand text-dark fs-5" href="#">MountHub</a>
    ...
    <div class="container">
        <h2>Produk Kami: Jaket Gunung</h2>
        <div class="row">
