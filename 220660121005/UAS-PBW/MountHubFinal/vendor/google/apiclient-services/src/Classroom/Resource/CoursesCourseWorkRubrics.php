...
class CoursesCourseWorkRubrics extends \Google\Service\Resource
{
   ...
   * user isn't permitted to create rubrics for course work in the requested
   * course. * `INTERNAL` if the request has insufficient OAuth scopes. *
   ...
   * `AttachmentNotVisible` (rubrics.create)
   *
